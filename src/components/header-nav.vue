<template>
  <div id="header">
    ...
    <div class="nav-sub" :class="{'active':isActive}" v-on:mouseleave="del()">
      <div class="nav-sub-wrapper">
        <div class="container">
          <ul class="nav-list">
            <li v-on:mouseenter="del()"><router-link to="/" >首页</router-link></li>
            <li v-on:mouseenter="add()"><router-link to="/Home" >手机</router-link></li>
            <li v-on:mouseenter="del()"><router-link to="/Mphone">“足迹系列”手感膜</router-link></li>
            <li v-on:mouseenter="del()"><router-link to="/PageOne">官方配件</router-link></li>
            <li v-on:mouseenter="del()"><router-link to="/PageTwo">周边产品</router-link></li>
            <li v-on:mouseenter="del()"><router-link to="/PageThree">第三方配件</router-link></li>
            <li v-on:mouseenter="del()"><router-link to="/PageFour">全部商品</router-link></li>
            <li v-on:mouseenter="del()"><router-link to="/PageFive">服务</router-link></li>
          </ul>
        </div>
      </div>
      <phone :active="isActive"></phone>
    </div>
  </div>
</template>
