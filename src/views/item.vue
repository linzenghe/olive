      ...
      <div class="item-box">
        <div class="gallery-wrapper">
          <div class="gallery">
            <div class="thumbnail">
              <ul>
                <li :class="{'on':index==imgIndex}" @click="tableImg(index)" v-for="(image,index) in itemInfo.ali_images">
            ...
            <div class="thumb">
              <ul>
                <li :class="{'on':index==imgIndex}" v-for="(image,index) in itemInfo.ali_images">
          ...
          <div class="sku-dynamic-params-panel">
            <div class="sku-dynamic-params clear">
              ...
              <ul class="params-colors">
                <li :class="{'cur':itemId==color.id}" v-for="(color,index) in itemInfo.sku_list">
